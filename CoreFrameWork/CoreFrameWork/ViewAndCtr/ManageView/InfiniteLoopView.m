...
- (void)initSubviews {
    ...
    self.pageControl.pageIndicatorImage = [UIImage resizeImage:[UIImage imageNamed:@"circle_pagecontrol_normal"]
                                                           toSize:AUTOLAYOUT_SIZE_WH(HeightOfPageControl, HeightOfPageControl)];
    self.pageControl.currentPageIndicatorImage = [UIImage resizeImage:[UIImage imageNamed:@"circle_pagecontrol_selected"]
                                                                  toSize:AUTOLAYOUT_SIZE_WH(HeightOfPageControl, HeightOfPageControl)];
